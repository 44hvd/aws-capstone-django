...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/volkan/capstone/username')
    password_param = ssm.get_parameter(Name="/volkan/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonevolkan.c5nqyugkcyex.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'volkancapstonestatic' # please enter your s3 bucket name
